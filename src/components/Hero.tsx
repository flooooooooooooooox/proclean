...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-navy via-navy-light to-brand-dark">
      <Particles />
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <span className="animate-drift-a absolute -left-24 top-0 h-72 w-72 rounded-full bg-brand/25 blur-3xl" />
        <span className="animate-drift-b absolute right-0 top-20 h-80 w-80 rounded-full bg-white/10 blur-3xl" />
        <span className="animate-drift-c absolute bottom-0 left-1/3 h-64 w-64 rounded-full bg-brand/20 blur-3xl" />
      </div>
