...
/** Communes couvertes, avec coordonnées (carte interactive + SEO local + GEO). */
export const communes: Commune[] = [
  { name: "Caen", lat: 49.1829, lng: -0.3707 },
  { name: "Hérouville-Saint-Clair", lat: 49.2044, lng: -0.3239 },
  { name: "Mondeville", lat: 49.1706, lng: -0.3244 },
  { name: "Ifs", lat: 49.1414, lng: -0.3489 },
  { name: "Fleury-sur-Orne", lat: 49.1478, lng: -0.3717 },
  { name: "Cormelles-le-Royal", lat: 49.1603, lng: -0.3339 },
  { name: "Louvigny", lat: 49.1594, lng: -0.3897 },
  { name: "Bretteville-sur-Odon", lat: 49.1706, lng: -0.4133 },
  { name: "Carpiquet", lat: 49.1836, lng: -0.4483 },
  { name: "Colombelles", lat: 49.2028, lng: -0.29 },
  { name: "Blainville-sur-Orne", lat: 49.2358, lng: -0.3103 },
  { name: "Épron", lat: 49.2178, lng: -0.3739 },
  { name: "Giberville", lat: 49.1839, lng: -0.2872 },
  { name: "Ouistreham", lat: 49.2769, lng: -0.2569 },
  { name: "Douvres-la-Délivrande", lat: 49.2939, lng: -0.3811 },
  { name: "Bernières-sur-Mer", lat: 49.3325, lng: -0.4225 },
  { name: "Ranville", lat: 49.2419, lng: -0.2606 },
  { name: "May-sur-Orne", lat: 49.0917, lng: -0.3703 },
  { name: "Villers-Bocage", lat: 49.0806, lng: -0.6519 },
  { name: "Bayeux", lat: 49.2764, lng: -0.7024 },
  { name: "Falaise", lat: 48.8936, lng: -0.1972 },
  { name: "Saint-Pierre-en-Auge", lat: 48.9744, lng: 0.0233 },
  { name: "Lisieux", lat: 49.1461, lng: 0.2258 },
  { name: "Honfleur", lat: 49.4189, lng: 0.2331 },
  { name: "Vire Normandie", lat: 48.8397, lng: -0.8894 },
];
